...
- Canopy API requests sent this run: `5`

## Portfolio summary

| Book | ASIN | Best Organic Rank Found | Best Keyword | Relevant Phrases Found |
|---|---|---:|---|---:|
| The Hollow Bell — Full Novel | `B0HD52HGGZ` | — | — | 0 |
| Second Draft | `B0HFYQ9KGV` | — | — | 0 |
| The Hollow Year | `B0HFXF8MTP` | — | — | 0 |
| The Absconding | `B0HDWRVSXQ` | — | — | 0 |
| The Correction | `B0HFV8KCVL` | — | — | 0 |

## The Hollow Bell — Full Novel
...
| Keyword | Organic Rank | Page | Results Scanned | Sponsored | Status |
|---|---:|---:|---:|:---:|---|
| reality bending mystery | — | — | 80 | No | not_found_after_5_pages_80_organic_results |
...
| Keyword | Organic Rank | Page | Results Scanned | Sponsored | Status |
|---|---:|---:|---:|:---:|---|
| New England folklore mystery | — | — | 77 | No | not_found_after_5_pages_77_organic_results |
